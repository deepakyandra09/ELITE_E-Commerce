...
SECRET_KEY = "deepakso"   # used for sessions

# MySQL Database Configuration (DEPRECATED)
DB_HOST = "localhost"
DB_USER = "root"
DB_PASSWORD = "Deepak@0325"
DB_NAME = "smart_db"
...
MAIL_PORT = 587
MAIL_USE_TLS = True
MAIL_USERNAME = 'deepakyandra99@gmail.com'
MAIL_PASSWORD = 'your_app_password'   # Gmail App Password

# UPI Configuration
UPI_VPA = 'deepakyandra99@okaxis'  # Change this to your active UPI VPA (e.g. yourname@ybl, yourname@oksbi)
UPI_MERCHANT_NAME = 'Elite Cart'    # Display name shown in scanner app
